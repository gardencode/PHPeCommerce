	...
	public function prepare () {
		...
		foreach ($people as $person) {
			...
			$action='&nbsp;<button class="btn btn-large btn-info" type="button"><a href="##site##admin/customer/view/'.$person->getID().'">View</a></button>'.
					'&nbsp;<button class="btn btn-large btn-success" type="button"><a href="##site##admin/customer/edit/'.$person->getID().'">Edit</a></button>'.
					'&nbsp;<button class="btn btn-large btn-danger" type="button"><a href="##site##admin/customer/delete/'.$person->getID().'">Delete</a></button>';
			$content.="<tr><td>$name</td><td>$action</td></tr>\n";
		}
		$content.="</table>\n";
		$content.='<p><a href="##site##admin/customer/new">Add a new person</a></p>';
